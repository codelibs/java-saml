...
public class LogoutRequestTest {
     ...
     * @throws Exception
     *
     * @see org.codelibs.saml2.core.core.logout.LogoutRequest#getEncodedLogoutRequest
     */
    @Test
     ...
     * @throws Exception
     *
     * @see org.codelibs.saml2.core.core.logout.LogoutRequest
     */
    @Test
     ...
     * @throws Exception
     *
     * @see org.codelibs.saml2.core.core.logout.LogoutRequest#getLogoutRequestXml
     */
    @Test
    ...
    public void testGetNameIdData() throws Exception {
        ...
        LogoutRequest logoutRequest =
                new LogoutRequest(settings, new LogoutRequestParams(null, "ONELOGIN_1e442c129e1f822c8096086a1103c5ee2c7cae1c"));
        String logoutRequestStringBase64 = logoutRequest.getEncodedLogoutRequest();
        String logoutRequestStr = Util.base64decodedInflated(logoutRequestStringBase64);
        assertThat(logoutRequestStr, containsString("<samlp:LogoutRequest"));
        ...
        logoutRequest = new LogoutRequest(settings, new LogoutRequestParams(null, "ONELOGIN_1e442c129e1f822c8096086a1103c5ee2c7cae1c",
                Constants.NAMEID_PERSISTENT, settings.getIdpEntityId(), settings.getSpEntityId()));
        logoutRequestStringBase64 = logoutRequest.getEncodedLogoutRequest();
        logoutRequestStr = Util.base64decodedInflated(logoutRequestStringBase64);
        assertThat(logoutRequestStr, containsString("<samlp:LogoutRequest"));
        nameIdDataStr = LogoutRequest.getNameIdData(logoutRequestStr, null).toString();
    ...
    public void testGetNameIdDataSpecialChars() throws Exception {
        ...
        assertThat(logoutRequestStr,
                containsString("<saml:NameID>&lt;ONELOGIN_1e442c129e1f822c8096086a1103c5ee2c7cae1c&gt;</saml:NameID>"));
        ...
        assertThat(logoutRequestStr, containsString(
                "<saml:NameID Format=\"urn:oasis:names:tc:SAML:2.0:nameid-format:entity\">http://idp.example.com/?a=1&amp;b=2</saml:NameID>"));
        assertThat(logoutRequestStr, not(containsString("SPNameQualifier")));
    }
     ...
     * @throws Exception
     *
     * @see org.codelibs.saml2.core.core.logout.LogoutRequest#getId
     */
    @Test
     ...
     * @throws Exception
     *
     * @see org.codelibs.saml2.core.core.logout.LogoutRequest#getIssueInstant(String)
     */
    @Test
     ...
     * @throws Exception
     *
     * @see org.codelibs.saml2.core.core.logout.LogoutRequest#getNameId
     */
    @Test
     ...
     *
     * @see org.codelibs.saml2.core.core.logout.LogoutRequest#getIssuer
     */
    @Test
     ...
     *
     * @see org.codelibs.saml2.core.core.logout.LogoutRequest#getSessionIndexes
     */
    @Test
    public void testGetSessionIndexes()
            throws URISyntaxException, IOException, XPathExpressionException, XMLSecurityException, SAMLSevereException {
        String logoutRequestStr = Util.getFileAsString("data/logout_requests/logout_request.xml");
    ...
    public void testIsInvalidIssuer() throws Exception {
        ...
        assertEquals(
                "Invalid issuer in the Logout Request. Was 'https://example.hello.com/access/saml', but expected 'http://idp.example.com/'",
    ...
    public void testIsInValidSign_defaultUrlEncode() throws Exception {
        ...
        String signature =
                "27tdJT0kmletQ/fSUhB6Y8L0S6Y7pcZlGFvOCCVcqZZDyxlZBaCfmLlDXhB3/oJrWRn8injiY44h1BnCsughYQjTGBWZi175J9HA/dYhMZ+IFw9V/oUrRTY8/o9kFQSIefhQcJoegY2BvJVDSKeqYg2mCcQnItyceLhS1eiEQy0=";

        HttpRequest httpRequest = new HttpRequest(requestURL).addParameter("SAMLRequest", samlRequestEncoded)
    ...
    public void testIsInValidSign_naiveUrlEncoding() throws Exception {
        ...
        HttpRequest httpRequest = new HttpRequest(requestURL, queryString).addParameter("SAMLRequest", samlRequestEncoded)
                .addParameter("RelayState", relayState).addParameter("SigAlg", sigAlg).addParameter("Signature", signatureNaiveEncoding);
     ...
     * @throws Exception
     *
     * @see org.codelibs.saml2.core.core.logout.LogoutRequest#getError
     */
    @Test
    public void testGetError() throws Exception {
        ...
        assertThat(logoutRequest.getError(), containsString("The LogoutRequest was received at"));
        assertTrue(logoutRequest.getValidationException() instanceof ValidationException);
     ...
     * @throws Exception
     * 
     * @see org.codelibs.saml2.core.core.logout.LogoutRequest#postProcessXml
     */
    @Test
