...
/**
 * Tests the org.codelibs.saml2.core.core.Metadata class
 */
public class MetadataTest {
     ...
     *
     * @throws Exception
     * @see org.codelibs.saml2.core.core.settings.Metadata
     */
    @Test
    ...
    public void testMetadataSpecialChars() throws Exception {
        ...
        assertThat(metadataStr, not(containsString("<md:KeyDescriptor use=\"signing\">")));
        assertThat(metadataStr, containsString(
                "<md:AssertionConsumerService Binding=\"urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST\" Location=\"http://localhost:8080/java-saml-jspsample/acs.jsp?a=1&amp;b=2\" index=\"1\"/>"));
        assertThat(metadataStr, containsString(
                "<md:SingleLogoutService Binding=\"urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect\" Location=\"http://localhost:8080/java-saml-jspsample/sls.jsp?a=1&amp;b=2\"/>"));
        assertThat(metadataStr, containsString("<md:NameIDFormat>urn:oasis:names:tc:SAML:1.1:nameid-format:unspecified</md:NameIDFormat>"));
    }
     ...
     * @throws CertificateEncodingException
     * @throws SAMLSevereException
     * @see org.codelibs.saml2.core.core.settings.Metadata#toContactsXml
     */
    @Test
    public void testToContactsXml() throws IOException, CertificateEncodingException, SAMLSevereException {
        ...
        String administrativeContactStr =
        ...
        String otherContactStr =
                "<md:ContactPerson contactType=\"other\"><md:Company>Big Corp</md:Company><md:EmailAddress>info@example.com</md:EmailAddress></md:ContactPerson>";
    ...
    public void testToContactsXmlLegacy() throws IOException, CertificateEncodingException, SAMLSevereException {
        ...
        String technicalContactStr =
                "<md:ContactPerson contactType=\"technical\"><md:GivenName>Technical Guy</md:GivenName><md:EmailAddress>technical@example.com</md:EmailAddress></md:ContactPerson>";
        assertThat(metadataStr, containsString(technicalContactStr));
        String supportContactStr =
                "<md:ContactPerson contactType=\"support\"><md:GivenName>Support Guy</md:GivenName><md:EmailAddress>support@example.com</md:EmailAddress></md:ContactPerson>";
    ...
    public void testToContactsXmlLegacySpecialChars() throws IOException, CertificateEncodingException, SAMLSevereException {
        ...
        String technicalContactStr =
                "<md:ContactPerson contactType=\"technical\"><md:GivenName>T&amp;chnical Guy</md:GivenName><md:EmailAddress>t&amp;chnical@example.com</md:EmailAddress></md:ContactPerson>";
        assertThat(metadataStr, containsString(technicalContactStr));
        String supportContactStr =
                "<md:ContactPerson contactType=\"support\"><md:GivenName>&quot;Support Guy&quot;</md:GivenName><md:EmailAddress>supp&amp;rt@example.com</md:EmailAddress></md:ContactPerson>";
        assertThat(metadataStr, containsString(supportContactStr));
    }
     ...
     * @throws CertificateEncodingException
     * @throws SAMLSevereException
     * @see org.codelibs.saml2.core.core.settings.Metadata#toOrganizationXml
     */
    @Test
    public void testToOrganizationXml() throws IOException, CertificateEncodingException, SAMLSevereException {
        ...
        String orgStr =
                "<md:Organization><md:OrganizationName xml:lang=\"en\">SP Java</md:OrganizationName><md:OrganizationDisplayName xml:lang=\"en\">SP Java Example</md:OrganizationDisplayName><md:OrganizationURL xml:lang=\"en\">http://sp.example.com</md:OrganizationURL></md:Organization>";
    ...
    public void testToLocalizedOrganizationXml() throws IOException, CertificateEncodingException, SAMLSevereException {
        ...
        String orgStr =
                "<md:Organization><md:OrganizationName xml:lang=\"fr\">SP Java</md:OrganizationName><md:OrganizationDisplayName xml:lang=\"fr\">SP Exemple Java</md:OrganizationDisplayName><md:OrganizationURL xml:lang=\"fr\">http://sp.example.com/fr</md:OrganizationURL></md:Organization>";
        assertThat(metadataStr, containsString(orgStr));
    ...
    public void testToOrganizationXmlSpecialChars() throws IOException, CertificateEncodingException, SAMLSevereException {
        ...
        String orgStr =
                "<md:Organization><md:OrganizationName xml:lang=\"en\">S&amp;P Java</md:OrganizationName><md:OrganizationDisplayName xml:lang=\"en\">S&amp;P Java &quot;Example&quot;</md:OrganizationDisplayName><md:OrganizationURL xml:lang=\"en\">http://sp.example.com?a=1&amp;b=2</md:OrganizationURL></md:Organization>";
        assertThat(metadataStr, containsString(orgStr));
    }
     ...
     * @throws CertificateEncodingException
     * @throws SAMLSevereException
     * @see org.codelibs.saml2.core.core.settings.Metadata#toSLSXml
     */
    @Test
     ...
     * @throws CertificateEncodingException
     * @throws SAMLSevereException
     * @see org.codelibs.saml2.core.core.settings.Metadata#toX509KeyDescriptorsXML
     */
    @Test
    public void testToX509KeyDescriptorsXML() throws IOException, CertificateEncodingException, SAMLSevereException {
        ...
        String keyDescriptorSignStr =
                "<md:KeyDescriptor use=\"signing\"><ds:KeyInfo xmlns:ds=\"http://www.w3.org/2000/09/xmldsig#\"><ds:X509Data><ds:X509Certificate>MIICeDCCAeGgAwIBAgIBADANBgkqhkiG9w0BAQ0FADBZMQswCQYDVQQGEwJ1czET";
        String keyDescriptorEncStr =
                "<md:KeyDescriptor use=\"encryption\"><ds:KeyInfo xmlns:ds=\"http://www.w3.org/2000/09/xmldsig#\"><ds:X509Data><ds:X509Certificate>MIICeDCCAeGgAwIBAgIBADANBgkqhkiG9w0BAQ0FADBZMQswCQYDVQQGEwJ1czET";
     ...
     * @throws CertificateEncodingException
     * @throws SAMLSevereException
     * @see org.codelibs.saml2.core.core.settings.Metadata#getAttributeConsumingServiceXml
     */
    @Test
    public void testGetAttributeConsumingServiceXml() throws IOException, CertificateEncodingException, SAMLSevereException {
        ...
        RequestedAttribute requestedAttribute =
                new RequestedAttribute("Email", "Email", true, "urn:oasis:names:tc:SAML:2.0:attrname-format:uri", null);
        RequestedAttribute requestedAttribute2 =
                new RequestedAttribute("FirstName", null, true, "urn:oasis:names:tc:SAML:2.0:attrname-format:uri", null);
        RequestedAttribute requestedAttribute3 =
                new RequestedAttribute("LastName", null, true, "urn:oasis:names:tc:SAML:2.0:attrname-format:uri", null);
        ...
        String reqAttr1Str =
                "<md:RequestedAttribute Name=\"Email\" NameFormat=\"urn:oasis:names:tc:SAML:2.0:attrname-format:uri\" FriendlyName=\"Email\" isRequired=\"true\" />";
        String reqAttr2Str =
                "<md:RequestedAttribute Name=\"FirstName\" NameFormat=\"urn:oasis:names:tc:SAML:2.0:attrname-format:uri\" isRequired=\"true\" />";
        String reqAttr3Str =
                "<md:RequestedAttribute Name=\"LastName\" NameFormat=\"urn:oasis:names:tc:SAML:2.0:attrname-format:uri\" isRequired=\"true\" />";
    ...
    public void testGetAttributeConsumingServiceXmlSpecialChars() throws IOException, CertificateEncodingException, SAMLSevereException {
        ...
        RequestedAttribute requestedAttribute =
                new RequestedAttribute("Email", "Email \"address\"", true, "urn:oasis:names:tc:SAML:2.0:attrname-format:uri", null);
        RequestedAttribute requestedAttribute2 =
                new RequestedAttribute("FirstName&LastName", null, true, "urn:oasis:names:tc:SAML:2.0:attrname-format:uri", null);
        ...
        String reqAttr1Str =
                "<md:RequestedAttribute Name=\"Email\" NameFormat=\"urn:oasis:names:tc:SAML:2.0:attrname-format:uri\" FriendlyName=\"Email &quot;address&quot;\" isRequired=\"true\" />";
        String reqAttr2Str =
                "<md:RequestedAttribute Name=\"FirstName&amp;LastName\" NameFormat=\"urn:oasis:names:tc:SAML:2.0:attrname-format:uri\" isRequired=\"true\" />";
        String footerStr = "</md:AttributeConsumingService>";
    ...
    public void testGetAttributeConsumingServiceXmlWithMultipleAttributeValue()
            throws IOException, CertificateEncodingException, SAMLSevereException {
        Saml2Settings settings = getSettingFromAllProperties();
        ...
        RequestedAttribute requestedAttribute =
                new RequestedAttribute("userType", null, false, "urn:oasis:names:tc:SAML:2.0:attrname-format:basic", attrValues);
        RequestedAttribute requestedAttribute2 = new RequestedAttribute("urn:oid:0.9.2342.19200300.100.1.1", "uid", true,
        ...
        String sDescStr = "<md:ServiceDescription xml:lang=\"en\">Test Service Desc</md:ServiceDescription>";
        String reqAttr1Str =
                "<md:RequestedAttribute Name=\"userType\" NameFormat=\"urn:oasis:names:tc:SAML:2.0:attrname-format:basic\" isRequired=\"false\">";
        ...
        String reqAttr2Str =
                "<md:RequestedAttribute Name=\"urn:oid:0.9.2342.19200300.100.1.1\" NameFormat=\"urn:oasis:names:tc:SAML:2.0:attrname-format:uri\" FriendlyName=\"uid\" isRequired=\"true\" />";
        String footerStr = "</md:AttributeConsumingService>";
    ...
    public void testGetAttributeConsumingServiceXmlWithMultipleAttributeValueSpecialChars()
        ...
        attrValues.add("admin");
        RequestedAttribute requestedAttribute =
                new RequestedAttribute("us&rType", null, false, "urn:oasis:names:tc:SAML:2.0:attrname-format:basic", attrValues);
        RequestedAttribute requestedAttribute2 = new RequestedAttribute("urn:oid:0.9.2342.19200300.100.1.1", "uid", true,
                "urn:oasis:names:tc:SAML:2.0:attrname-format:uri", null);
        ...
        String sDescStr = "<md:ServiceDescription xml:lang=\"en\">T&amp;st Service Desc</md:ServiceDescription>";
        String reqAttr1Str =
                "<md:RequestedAttribute Name=\"us&amp;rType\" NameFormat=\"urn:oasis:names:tc:SAML:2.0:attrname-format:basic\" isRequired=\"false\">";
        String reqAttr1Atr1Str =
                "<saml:AttributeValue xmlns:saml=\"urn:oasis:names:tc:SAML:2.0:assertion\">us&amp;rType</saml:AttributeValue>";
        String reqAttr1Attr2Str = "<saml:AttributeValue xmlns:saml=\"urn:oasis:names:tc:SAML:2.0:assertion\">admin</saml:AttributeValue>";
        String reqAttr2Str =
                "<md:RequestedAttribute Name=\"urn:oid:0.9.2342.19200300.100.1.1\" NameFormat=\"urn:oasis:names:tc:SAML:2.0:attrname-format:uri\" FriendlyName=\"uid\" isRequired=\"true\" />";
        String footerStr = "</md:AttributeConsumingService>";
     ...
     * @see org.codelibs.saml2.core.core.settings.Metadata#signMetadata
     */
    @Test
     ...
     */
    @Test
    public void testSigngeneratedMetadata()
            throws SAMLSevereException, IOException, GeneralSecurityException, XPathExpressionException, XMLSecurityException {
        Saml2Settings settings = getSettingFromAllProperties();
        String certString = Util.getFileAsString("data/customPath/certs/sp.crt");
        X509Certificate cert = Util.loadCert(certString);
        String keyString = Util.getFileAsString("data/customPath/certs/sp.pem");
    ...
    public void shouldIncludeValidUntilAndDuration() throws CertificateEncodingException, SAMLSevereException, IOException {
        ...
        assertEquals("should set valid until attribute", Util.formatDateTime(validUntil.getTimeInMillis()),
                validUntilNode.getTextContent());
     ...
     * @throws Exception
     * 
     * @see org.codelibs.saml2.core.core.settings.Metadata#postProcessXml
     */
    @Test
