...
import org.codelibs.saml2.core.exception.XMLEntityException;
...
public class LogoutResponseTest {
	 ...
	 * @throws Exception
	 *
	 * @see org.codelibs.saml2.core.core.logout.LogoutResponse#getEncodedLogoutResponse
	 */
	@Test
	 ...
	 *
	 * @see org.codelibs.saml2.core.core.logout.LogoutResponse
	 */
	@Test
	public void testReceivedMessageConstructor() throws IOException, XMLEntityException, URISyntaxException, SAMLSevereException {
		Saml2Settings settings = new SettingsBuilder().fromFile("config/config.min.properties").build();
	 ...
	 * @throws SAMLSevereException
	 *
	 * @see org.codelibs.saml2.core.core.logout.LogoutResponse#build
	 */
	@Test
	public void testOutgoingMessageConstructor() throws IOException, XMLEntityException, URISyntaxException, SAMLSevereException {
		Saml2Settings settings = new SettingsBuilder().fromFile("config/config.min.properties").build();
	 ...
	 */
	@Test
	public void testBuild() throws IOException, XMLEntityException, URISyntaxException, SAMLSevereException {
		Saml2Settings settings = new SettingsBuilder().fromFile("config/config.min.properties").build();
	 ...
	 * @throws Exception
	 *
	 * @see org.codelibs.saml2.core.core.logout.LogoutResponse#getLogoutResponseXml
	 */
	@Test
	 ...
	 * @throws SAMLSevereException
	 *
	 * @see org.codelibs.saml2.core.core.logout.LogoutResponse#getStatus
	 */
	@Test
	public void testGetStatus() throws IOException, URISyntaxException, XMLEntityException, XPathExpressionException, SAMLSevereException {
		Saml2Settings settings = new SettingsBuilder().fromFile("config/config.min.properties").build();
		String samlResponseEncoded = Util.getFileAsString("data/logout_responses/logout_response_deflated.xml.base64");
		final String requestURL = "/";
		HttpRequest httpRequest = newHttpRequest(requestURL, samlResponseEncoded);
	 ...
	 * @throws SAMLSevereException
	 *
	 * @see org.codelibs.saml2.core.core.logout.LogoutResponse#getIssuer
	 */
	@Test
	public void testGetIssuer() throws IOException, URISyntaxException, XMLEntityException, XPathExpressionException, SAMLSevereException {
		Saml2Settings settings = new SettingsBuilder().fromFile("config/config.min.properties").build();
		String samlResponseEncoded = Util.getFileAsString("data/logout_responses/logout_response_deflated.xml.base64");
		final String requestURL = "/";
		HttpRequest httpRequest = newHttpRequest(requestURL, samlResponseEncoded);
	 ...
	 *
	 * @see org.codelibs.saml2.core.core.logout.LogoutResponse#getIssueInstant()
	 */
	@Test
	 ...
	 */
	@Test
	public void testIsValidNoResponse() throws XMLEntityException, IOException, SAMLSevereException {
		Saml2Settings settings = new SettingsBuilder().fromFile("config/config.min.properties").build();
		final String requestURL = "/";
	 ...
	 */
	@Test
	public void testIsInValidRequestId() throws XMLEntityException, IOException, URISyntaxException, SAMLSevereException {
		Saml2Settings settings = new SettingsBuilder().fromFile("config/config.min.properties").build();
		String samlResponseEncoded = Util.getFileAsString("data/logout_responses/logout_response_deflated.xml.base64");
	 ...
	 */
	@Test
	public void testIsInValidIssuer() throws XMLEntityException, IOException, URISyntaxException, SAMLSevereException {
		Saml2Settings settings = new SettingsBuilder().fromFile("config/config.min.properties").build();
	 ...
	 */
	@Test
	public void testIsInValidWrongXML() throws XMLEntityException, IOException, URISyntaxException, SAMLSevereException {
		Saml2Settings settings = new SettingsBuilder().fromFile("config/config.min.properties").build();
	 ...
	 */
	@Test
	public void testIsInValidDestination() throws XMLEntityException, IOException, URISyntaxException, SAMLSevereException {
		Saml2Settings settings = new SettingsBuilder().fromFile("config/config.min.properties").build();
		String samlResponseEncoded = Util.getFileAsString("data/logout_responses/logout_response_deflated.xml.base64");
		final String requestURL = "/";
		HttpRequest httpRequest = newHttpRequest(requestURL, samlResponseEncoded);
	 ...
	 */
	@Test
	public void testIsValid() throws URISyntaxException, IOException, XMLEntityException, SAMLSevereException {
		Saml2Settings settings = new SettingsBuilder().fromFile("config/config.min.properties").build();
		String samlResponseEncoded = Util.getFileAsString("data/logout_responses/logout_response_deflated.xml.base64");
		String requestURL = "/";
		HttpRequest httpRequest = newHttpRequest(requestURL, samlResponseEncoded);
	 ...
	 */
	@Test
	public void testIsInValidSign() throws URISyntaxException, IOException, XMLEntityException, SAMLSevereException {
	 ...
	 */
	@Test
	public void testIsInValidSignWithDeprecatedAlg() throws URISyntaxException, IOException, XMLEntityException, SAMLSevereException {
		Saml2Settings settings = new SettingsBuilder().fromFile("config/config.my.properties").build();
		settings.setStrict(false);
		settings.setWantMessagesSigned(true);
	 ...
	 */
	@Test
	public void testIsValidNoLogoutResponse() throws IOException, XMLEntityException, SAMLSevereException {
		Saml2Settings settings = new SettingsBuilder().fromFile("config/config.min.properties").build();
		final String requestURL = "/";
		HttpRequest httpRequest = newHttpRequest(requestURL, "");
	 ...
	 * @throws SAMLSevereException
	 *
	 * @see org.codelibs.saml2.core.core.logout.LogoutResponse#getError
	 */
	@Test
	public void testGetError() throws URISyntaxException, IOException, XMLEntityException, SAMLSevereException {
		Saml2Settings settings = new SettingsBuilder().fromFile("config/config.min.properties").build();
		settings.setStrict(true);
		String samlResponseEncoded = Util.getFileAsString("data/logout_responses/logout_response_deflated.xml.base64");
		final String requestURL = "/";
		...
		assertThat(logoutResponse.getError(), containsString("The LogoutResponse was received at"));
		assertTrue(logoutResponse.getValidationException() instanceof ValidationException);
	 ...
	 * @throws Exception
	 * 
	 * @see org.codelibs.saml2.core.core.logout.LogoutResponse#postProcessXml
	 */
	@Test
