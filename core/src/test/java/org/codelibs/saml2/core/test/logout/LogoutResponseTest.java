...
public class LogoutResponseTest {
    ...
    public void testGetEncodedLogoutResponseSimulated() throws Exception {
        ...
        String expectedLogoutResponseStringBase64Deflated =
                Util.getFileAsString("data/logout_responses/logout_response_deflated.xml.base64");
    ...
    public void testOutgoingMessageConstructor() throws IOException, XMLSecurityException, URISyntaxException, SAMLSevereException {
        ...
        LogoutResponse logoutResponse3 =
                new LogoutResponse(settings, new LogoutResponseParams("inResponseValue", Constants.STATUS_VERSION_MISMATCH));
        ...
        assertThat(logoutResponseStr, containsString("<samlp:LogoutResponse"));
        assertThat(logoutResponseStr, containsString("InResponseTo=\"inResponseValue\""));
        assertThat(logoutResponseStr, containsString("<samlp:StatusCode Value=\"" + Constants.STATUS_RESPONDER
                + "\"><samlp:StatusCode Value=\"" + Constants.STATUS_PARTIAL_LOGOUT + "\" /></samlp:StatusCode>"));
        assertThat(logoutResponseStr, not(containsString("<samlp:StatusMessage>")));
    ...
    public void testGetLogoutResponseXml() throws Exception {
        ...
        assertThat(logoutResponseXML,
                containsString("Destination=\"http://idp.example.com/simplesaml/saml2/idp/SingleLogoutService.php\""));
    ...
    public void testGetLogoutResponseXmlSpecialChars() throws Exception {
        ...
        assertThat(logoutResponseXML, containsString("<samlp:LogoutResponse"));
        assertThat(logoutResponseXML,
                containsString("Destination=\"http://idp.example.com/simplesaml/saml2/idp/SingleLogoutService.php?a=1&amp;b=2\""));
    ...
    public void testGetStatus()
            throws IOException, URISyntaxException, XMLSecurityException, XPathExpressionException, SAMLSevereException {
        Saml2Settings settings = new SettingsBuilder().fromFile("config/config.min.properties").build();
        String samlResponseEncoded = Util.getFileAsString("data/logout_responses/logout_response_deflated.xml.base64");
        final String requestURL = "/";
        HttpRequest httpRequest = newHttpRequest(requestURL, samlResponseEncoded);
    ...
    public void testIsInValidIssuer() throws XMLSecurityException, IOException, URISyntaxException, SAMLSevereException {
        ...
        settings.setStrict(true);
        assertFalse(logoutResponse.isValid());
        assertEquals("Invalid issuer in the Logout Response. Was 'http://invalid.example.com/', but expected 'http://idp.example.com/'",
    ...
    public void testIsInValidSign() throws URISyntaxException, IOException, XMLSecurityException, SAMLSevereException {
        ...
        HttpRequest httpRequest = new HttpRequest(requestURL, (String) null).addParameter("SAMLResponse", samlResponseEncoded)
                .addParameter("RelayState", relayState).addParameter("SigAlg", sigAlg).addParameter("Signature", signature);
        ...
        logoutResponse = new LogoutResponse(settings, httpRequest);
        assertFalse(logoutResponse.isValid());
        assertEquals("In order to validate the sign on the Logout Response, the x509cert of the IdP is required",
                logoutResponse.getError());
    }
